...
import com.viewnext.eventframework.adapter.in.websocket.EventWebSocketHandler;
...
public class DemoWebSocketConfig implements WebSocketConfigurer {
    ...
    public DemoWebSocketConfig(SubscriptionRegistry registry, ObjectMapper objectMapper,AuthProvider authProvider,AuthorizationProvider authorizationProvider) {
